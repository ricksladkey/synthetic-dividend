...
print(f'Algorithm settings: rebalance={algo.rebalance_size:.6f}, profit={algo.profit_sharing:.6f}\n')

transactions, summary = run_algorithm_backtest(df, 'NVDA', 1000, date(2024, 1, 1), date(2024, 2, 29), algo)
