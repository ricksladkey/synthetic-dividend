...
Asset is a factory that delegates to registered providers:
- USD → CashAssetProvider (flat $1.00 prices)
- NVDA, etc. → YahooAssetProvider (Yahoo Finance data)
- Future: crypto providers, custom instruments, mock data

Providers are registered in AssetRegistry with priority-based lookup.
"""
