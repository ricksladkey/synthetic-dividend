...
Examples:
    ...
    # Run portfolio backtest with inflation adjustment
    synthetic-dividend-tool run portfolio --allocations '{"NVDA": 0.4, "VOO": 0.6}' --start 2024-01-01 --end 2024-12-31 --adjust-inflation --verbose
