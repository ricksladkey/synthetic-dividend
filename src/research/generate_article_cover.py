...
def generate_cover_image(output_path: str = None):
    ...
    # Title and subtitle
    fig.suptitle(
        "Volatility Harvesting: Empirical Results",
        fontsize=32,
        fontweight="bold",
        y=0.98,
        color="#1a1a1a",
    ...
    ax.set_title(
        "3-Year Backtests Using Synthetic Dividend Algorithm (SD6/SD8/SD16)",
        fontsize=16,
        pad=20,
        color="#555555",
        style="italic",
    ...
    fig.text(
        0.99,
        0.02,
        "No derivatives • No market timing • Systematic rebalancing only",
        ha="right",
        va="bottom",
        fontsize=11,
        color="#888888",
