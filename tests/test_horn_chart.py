...
daily_chart = create_portfolio_horn_chart(
    summary, output="horn_chart_daily.png", resample=None  # or 'D'
)
print(f"   Saved to: {daily_chart}")

# Weekly resolution
print("\n2. Weekly resolution (~52 data points)...")
weekly_chart = create_portfolio_horn_chart(summary, output="horn_chart_weekly.png", resample="W")
print(f"   Saved to: {weekly_chart}")

# Monthly resolution
print("\n3. Monthly resolution (12 data points)...")
monthly_chart = create_portfolio_horn_chart(summary, output="horn_chart_monthly.png", resample="M")
