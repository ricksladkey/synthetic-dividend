...
def test_allow_margin_true_bank_can_go_negative():
    ...
    assert summary['bank_min'] < 0, f"Bank should go negative in allow_margin=True mode, got {summary['bank_min']}"
...
def test_allow_margin_comparison():
    ...
    print(f"Margin mode: bank_min={summary_margin['bank_min']:.2f}, skipped={summary_margin['skipped_buys']}")
    print(f"Strict mode: bank_min={summary_strict['bank_min']:.2f}, skipped={summary_strict['skipped_buys']}")
