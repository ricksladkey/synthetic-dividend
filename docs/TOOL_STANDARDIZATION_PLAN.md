...
2. **docs/TOOL_USE_CASES.md**: [OK] Already created
3. **theory/RETURN_ADJUSTMENT_FRAMEWORK.md**: [OK] Already created
...
[OK] **Argument consistency**: All subcommands use identical names
[OK] **Return adjustments**: Inflation and market adjustments available everywhere
[OK] **Extensibility**: Uses existing Asset provider system
[OK] **Documentation**: Theory docs + use case guide + inline help
[OK] **Testing**: Unit and integration test coverage
