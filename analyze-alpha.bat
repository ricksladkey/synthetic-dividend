...
if "%~1"=="" (
    echo Usage: analyze-alpha.bat TICKER START_DATE END_DATE [OPTIONS]
    echo.
    echo Examples:
    echo   analyze-alpha.bat GLD 10/26/2024 10/26/2025
    echo   analyze-alpha.bat NVDA 10/23/2023 10/23/2024
    echo   analyze-alpha.bat AAPL 01/01/2024 12/31/2024 --sd 8
    echo   analyze-alpha.bat MSFT 01/01/2024 12/31/2024 --profit-sharing 75
    echo.
    echo The tool will:
