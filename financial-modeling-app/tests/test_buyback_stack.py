...
class TestBuybackStackGradualRise:
    ...
    def test_exponential_rise_100_days(self):
        ...
        assert stack_empty, \
            f"Buyback stack should be empty: {stack_qty} shares remaining"
...
class TestBuybackStackVShape:
    ...
    def test_v_shape_exceeds_ath(self):
        ...
        assert stack_empty, \
            f"Stack should be empty at new ATH: {stack_qty} shares remaining"
...
class TestBuybackStackDrawdown:
    ...
    def test_drawdown_at_end(self):
        ...
        assert not stack_empty, \
            "Buyback stack should be non-empty during drawdown"
    ...
    def test_deep_drawdown(self):
        ...
        # Stack non-empty
        assert not stack_empty, \
            "Stack should be non-empty in deep drawdown"
        
        # Verify stack accounts for difference
        assert stack_qty == (sd_full - ath_only), \
            "Stack should account for all extra shares"
...
class TestBuybackStackMultipleCycles:
    ...
    def test_three_complete_cycles(self):
        ...
        price_path = (cycle1_up + cycle1_down + 
                     cycle2_up + cycle2_down + 
                     cycle3_up)
