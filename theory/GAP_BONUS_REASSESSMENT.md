...
## Multi-Bracket Gap Stack Symmetry (Implementation Detail)
...
1. **LIFO unwind #1**: Sell at $100.00 → pops most recent stack entry ($83.94 lot)
2. **LIFO unwind #2**: Sell at $91.62 → pops next stack entry ($91.62 lot)
